	...
	<footer class="footer bg-black">
		<div class="container ">
			...
			<div class="footer-contact-infor">
				<div class="mb-3">
					<div class="text-white navFont">CS CENTER 1522-2041 평일 10:00 ~ 17:00 (점심 12:00 ~ 13:00) </div>
					<div class="text-gray navFont">soo@p2u.kr토요일, 일요일, 공휴일은 휴무입니다. 근무시간 이후 문의는 1:1 문의를 이용해주세요.</div>
				</div>

				<div class="mb-3">
					<div class="text-white navFont">CS CENTER 1522-2041 평일 10:00 ~ 17:00 (점심 12:00 ~ 13:00) </div>
					<div class="text-gray">soo@p2u.kr토요일, 일요일, 공휴일은 휴무입니다. 근무시간 이후 문의는 1:1 문의를 이용해주세요.</div>
				</div>
			...
			<div class="footer-copyright-new text-left text-gray">
			...
			<div class="d-flex w-50 mt-3">
				...
				<div class="text-white flex-me navFont">이메일무단수집거부</div>
			</div>
